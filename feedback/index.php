...
$form['form-1'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Заказ полета',
		'title' => 'Пользователь хочет сделать заказ!',
		'ajax' => true,
		'validate' => false,
		'from_email' => 'urglokki@mail.ru',
		'from_name' => 'Fly_SPB.ru',
		'to_email' => 'urglokki@gmail.com',
		'to_name' => 'smollolsmol',
		'geoip' => true,
		'referer' => true,
		'type' => 'html',
		...
		'okay' => '<h1 class="sanks">СПАСИБО!</h1><div class="sanks_msg">МЫ ПОЛУЧИЛИ ВАШУ ЗАЯВКУ И СВЯЖЕМСЯ С ВАМИ<br>В БЛИЖАЙШЕЕ ВРЕМЯ</div>',
		'fuck' => '<div style="text-align: center">Упс, что-то пошло не так :( <br>Поробуйте позже</div> ',
		'spam' => 'Cпам робот',
		'notify' => 'color-modal',
		'usepresuf' => false
	)
...
$form['fly_with_sale'] = array(
    ...
    'cfg' => array(
        'charset' => 'utf-8',
        'subject' => 'Заказ паратрайка',
        'title' => 'Пользователь хочет летать со скидкой!!',
        'ajax' => true,
        'validate' => true,
        'from_email' => 'urglokki@mail.ru',
        'from_name' => 'Fly_SPB.ru',
...
$form['fly_paratrike'] = array(
    ...
    'cfg' => array(
        'charset' => 'utf-8',
        'subject' => 'Заказ параплана',
        'title' => 'Пользователь откликнулся на лэндинг',
        'ajax' => true,
        'validate' => true,
        'from_email' => 'urglokki@mail.ru',
        'from_name' => 'Fly_SPB.ru',
